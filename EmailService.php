...
class EmailService{
	public $mensaje_ok 			= 'Formulario enviado con exito, gracias por contactarme';
	public $mensaje_error 		= 'Lo siento, ocurrió un error al enviar su formulario';
	public $mensaje_validacion 	= 'Debe completar todos los campos';
	public $destino 			= 'hola@angelcorral.mx'; // !important
	public $asunto  			= 'Contacto Pagina Angel Corral'; 
	...
	protected function filtrar($data){
		if ( empty($data['nombre']) || empty($data['telefono']) || empty($data['correo']) || empty($data['comentarios'])){
			return false;
		}
